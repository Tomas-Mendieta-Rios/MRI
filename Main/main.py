...
class StreamlitApp:
    ...
    def apply_filters(self):
        ...
        # Check if session state is initialized and apply filters
        ...
        if st.session_state.get('categorize_ages', False):
            ...
            # Remove the age category column if it exists
        ...
        # Save the filtered DataFrame back to session state
    ...
    def display_sidebar(self):
        ...
        # Unique key for "Categorize Ages" checkbox
    ...
    def FOTICO_luz_natural_8_15_integrada(self):
            # Ensure 'age_category' exists in the filtered dataframe
            ...
            # Create an interactive histogram using Plotly with a sub-hue for age category
            fig = px.histogram(
            ...
            # Update layout to ensure clear display
            fig.update_layout(
    ...
    def FOTICO_luz_ambiente_8_15_luzelect_si_no_integrada(self):
        ...
        fig = px.histogram(
            ...
            category_orders={
                ...
                "FOTICO_luz_ambiente_8_15_luzelect_si_no_integrada": [0, 1]  # Only show 0 and 1
            }, 
        ...
        # Update layout to ensure clear display
        fig.update_layout(
            xaxis=dict(tickmode='array', tickvals=[0, 1], ticktext=['0', '1']),  # Only show 0 and 1
            yaxis_title='Cantidad de usuarios',
            xaxis_title='',  # This will hide the long variable name on the x-axis
            legend_title_text='Género'
        )
    ...
    def display_data_and_plots(self):
        # Display the filtered data and selected plot
        ...
        if filtered_length > 0:
            if st.session_state.plot_type ==  "Exposición a la luz nartifi":
                self.FOTICO_luz_natural_8_15_integrada()
        else:
